...
function generateSlug(name) {
    return name
        ...
        .toLowerCase()
        .replace(/[^a-zа-яё0-9\s-]/gimu, "") // оставить только буквы и цифры
        .replace(/[\s_]+/g, "-") // пробелы и подчеркивания → дефисы
        .replace(/-+/g, "-") // убрать дублирование дефисов
        .replace(/^-|-$/g, "") // убрать дефис в начале и конце
}
